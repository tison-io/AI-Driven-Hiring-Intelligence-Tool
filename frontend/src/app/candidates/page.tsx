    ...
    <Layout>
      <div className="p-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-400">Filter and manage your candidate pool</p>
        </div>
          ...
          <div className="grid grid-cols-2 gap-8">
            ...
            <div>
              ...
              <input
                ...
                max="100"
                value={minRole}
                onChange={(e) => setMinRole(parseInt(e.target.value))}
                className="w-full h-2 bg-gray-700 rounded-lg appearance-none cursor-pointer accent-gray-500"
              />
            </div>
          </div>
              ...
              <tbody className="divide-y divide-gray-200">
                {candidates.map((candidate) => (
                  <tr key={candidate.id} className="hover:bg-gray-50 transition-colors">
                    ...
                    <td className="py-4 px-6">
                      <p className="text-gray-700">{candidate.targetRole}</p>
                    </td>
                    <td className="py-4 px-6">
                    ...
                    <td className="py-4 px-6">
                      <span className={`inline-flex items-center px-3 py-1 rounded-full text-xs font-semibold ${getRoleFitBadge(candidate.rolefit)}`}>
                        {candidate.rolefit}
                      </span>
                    </td>
                    <td className="py-4 px-6">
                      <span className="text-gray-700">{candidate.confidence}%</span>
                    </td>
                    <td className="py-4 px-6">
                      <span className={`inline-flex items-center px-3 py-1 rounded-full text-xs font-medium border ${getStatusBadge(candidate.status)}`}>
                        {candidate.status}
                      </span>
                    </td>
                    <td className="py-4 px-6">
